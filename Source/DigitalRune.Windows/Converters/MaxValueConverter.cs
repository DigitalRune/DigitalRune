...
namespace DigitalRune.Windows
{
    ...
    {
        /// <summary>
        /// Gets an instance of the <see cref="MaxValueConverter"/>.
        /// </summary>
        /// <value>An instance of the <see cref="MaxValueConverter"/>.</value>
        public static MaxValueConverter Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new MaxValueConverter();

                return _instance;
            }
        }
        private static MaxValueConverter _instance;

...
namespace DigitalRune.Windows.Interop
{
    ...
    /// <summary>
    /// The <see cref="Win32.SetWindowPos"/> flags. (See SWP_ constants in "winuser.h".)
    /// </summary>
    [CLSCompliant(false)]
    [Flags]
    public enum SetWindowPosFlags : uint
    {
        ...
        /// bars), and any part of the parent window uncovered as a result of the window being
        /// moved. When this flag is set, the application must explicitly invalidate or redraw any
        ...
        /// <summary>
        /// Applies new frame styles set using the <see cref="Win32.SetWindowLong"/> function. Sends
        /// a <see cref="WindowMessages.WM_NCCALCSIZE"/> message to the window, even if the window's
        /// size is not being changed. If this flag is not specified,
        /// <see cref="WindowMessages.WM_NCCALCSIZE"/> is sent only when the window's size is being
        /// changed.
        /// </summary>
        ...
        /// <summary>
        /// Prevents the window from receiving the <see cref="WindowMessages.WM_WINDOWPOSCHANGING"/>
        /// message.
        /// </summary>

...
namespace DigitalRune.Windows.Interop
{
    ...
    public static class WindowMessages
    {
        ...
        /// <summary>
        /// An application sends the WM_SETTINGCHANGE message to all top-level windows after making
        /// a change to the WIN.INI file. The SystemParametersInfo function sends this message after
        ...
        /// </summary>
        [Obsolete("WM_COMMNOTIFY is Obsolete for Win32-Based Applications.")]
        ...
        /// key is pressed. A nonsystem key is a key that is pressed when the ALT key is not
        /// pressed.
        /// </summary>
        ...
        /// can use the display context handle to set the background color of the scroll bar
        /// control.
        /// </summary>
        ...
        /// DefWindowProc propagates it up the parent chain until it finds a window that processes
        /// it.
        /// </summary>
        ...
        /// this message, the application calls the SendMessage function with the following
        /// parameters.
        /// </summary>
        ...
        /// do not have the keyboard focus to realize their logical palettes and update their client
        /// areas.
        /// </summary>

...
{
  /// <summary>
  /// Writes a <see cref="Vector4D"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class Vector4DWriter : ContentTypeWriter<Vector4D>
  {
    ...
    {
      return typeof(Vector4D).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(Vector4DReader).AssemblyQualifiedName;
    }
    ...
    protected override void Write(ContentWriter output, Vector4D value)
    {

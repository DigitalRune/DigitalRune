...
{
  /// <summary>
  /// Writes a <see cref="PathKey2F"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class PathKey2FWriter : ContentTypeWriter<PathKey2F>
  {
    /// <summary>
    ...
    {
      return typeof(PathKey2F).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(PathKey2FReader).AssemblyQualifiedName;
    }
    ...
    protected override void Write(ContentWriter output, PathKey2F value)
    {

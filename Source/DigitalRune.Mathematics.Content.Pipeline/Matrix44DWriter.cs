...
{
  /// <summary>
  /// Writes a <see cref="Matrix44D"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class Matrix44DWriter : ContentTypeWriter<Matrix44D>
  {
    /// <summary>
    ...
    {
      return typeof(Matrix44D).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(Matrix44DReader).AssemblyQualifiedName;
    }
    ...
    protected override void Write(ContentWriter output, Matrix44D value)
    {

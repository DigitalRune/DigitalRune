...
{
  /// <summary>
  /// Writes a <see cref="Matrix33D"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class Matrix33DWriter : ContentTypeWriter<Matrix33D>
  {
    /// <summary>
    ...
    {
      return typeof(Matrix33D).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(Matrix33DReader).AssemblyQualifiedName;
    }
    ...
    protected override void Write(ContentWriter output, Matrix33D value)
    {

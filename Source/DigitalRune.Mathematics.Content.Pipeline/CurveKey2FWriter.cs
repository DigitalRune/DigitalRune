...
namespace DigitalRune.Mathematics.Content.Pipeline
{
  ...
  /// </summary>
  [ContentTypeWriter]
  public class CurveKey2FWriter : ContentTypeWriter<CurveKey2F>
  {
    /// <summary>
    ...
    {
      return typeof(CurveKey2F).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(CurveKey2FReader).AssemblyQualifiedName;
    }
    ...
    protected override void Write(ContentWriter output, CurveKey2F value)
    {

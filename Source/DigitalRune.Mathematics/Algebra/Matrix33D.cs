...
namespace DigitalRune.Mathematics.Algebra
{
  ...
  public struct Matrix33D : IEquatable<Matrix33D>
  {
    ...
    /// </summary>
    public static readonly Matrix33D Zero = new Matrix33D(0, 0, 0,
                                                          0, 0, 0,
                                                          0, 0, 0);

    /// <summary>
    /// Returns a <see cref="Matrix33D"/> with all of its components set to one.
    /// </summary>
    public static readonly Matrix33D One = new Matrix33D(1, 1, 1,
                                                         1, 1, 1,
                                                         1, 1, 1);
    ...
    /// </summary>
    public static readonly Matrix33D Identity = new Matrix33D(1, 0, 0,
                                                              0, 1, 0,
                                                              0, 0, 1);
    #endregion
    ...
    public bool IsOrthogonal
    {
      get
      {
        ...
        return AreNumericallyEqual(Identity, this * Transposed, Numeric.EpsilonD * 10);
      }
    }
    ...
    /// <overloads>
    /// <summary>
    /// Initializes a new instance of the <see cref="Matrix33D"/> class.
    /// </summary>
    /// </overloads>
    /// 
    /// <summary>
    /// Initializes a new instance of the <see cref="Matrix33D"/> struct.
    /// </summary>
    ...
    /// </remarks>
    public Matrix33D(double elementValue)
    ...
    {
      return obj is Matrix33D && this == (Matrix33D)obj;
    }


    #region IEquatable<Matrix33D> Members
    /// <summary>
    ...
    /// <see langword="false"/>.
    /// </returns>
    public bool Equals(Matrix33D other)
    {
      return this == other;
    }
    #endregion
    ...
    /// </remarks>
    public static Matrix33D operator -(Matrix33D matrix)
    {
    ...
    /// Each element of the matrix is negated.
    /// </remarks>
    public static Matrix33D Negate(Matrix33D matrix)
    {
      matrix.M00 = -matrix.M00; matrix.M01 = -matrix.M01; matrix.M02 = -matrix.M02;
      matrix.M10 = -matrix.M10; matrix.M11 = -matrix.M11; matrix.M12 = -matrix.M12;
      matrix.M20 = -matrix.M20; matrix.M21 = -matrix.M21; matrix.M22 = -matrix.M22;
    ...
    public static Matrix33D operator +(Matrix33D matrix1, Matrix33D matrix2)
    {
    ...
    /// <param name="matrix2">The second Matrix.</param>
    /// <returns>The sum of the two matrices.</returns>
    public static Matrix33D Add(Matrix33D matrix1, Matrix33D matrix2)
    {
      matrix1.M00 += matrix2.M00; matrix1.M01 += matrix2.M01; matrix1.M02 += matrix2.M02;
      matrix1.M10 += matrix2.M10; matrix1.M11 += matrix2.M11; matrix1.M12 += matrix2.M12;
      matrix1.M20 += matrix2.M20; matrix1.M21 += matrix2.M21; matrix1.M22 += matrix2.M22;
    ...
    public static Matrix33D operator -(Matrix33D minuend, Matrix33D subtrahend)
    {
    ...
    /// <param name="subtrahend">The second matrix (subtrahend).</param>
    /// <returns>The difference of the two matrices.</returns>
    public static Matrix33D Subtract(Matrix33D minuend, Matrix33D subtrahend)
    {
      minuend.M00 -= subtrahend.M00;
      minuend.M01 -= subtrahend.M01;
      minuend.M02 -= subtrahend.M02;
    ...
    public static Matrix33D operator *(Matrix33D matrix, double scalar)
    {
    ...
    /// <param name="matrix">The matrix.</param>
    /// <returns>The matrix with each element multiplied by <paramref name="scalar"/>.</returns>
    public static Matrix33D operator *(double scalar, Matrix33D matrix)
    {
      matrix.M00 *= scalar; matrix.M01 *= scalar; matrix.M02 *= scalar;
      matrix.M10 *= scalar; matrix.M11 *= scalar; matrix.M12 *= scalar;
      matrix.M20 *= scalar; matrix.M21 *= scalar; matrix.M22 *= scalar;
    ...
    /// <param name="scalar">The scalar.</param>
    /// <returns>The matrix with each element multiplied by <paramref name="scalar"/>.</returns>
    public static Matrix33D Multiply(double scalar, Matrix33D matrix)
    {
      matrix.M00 *= scalar; matrix.M01 *= scalar; matrix.M02 *= scalar;
      matrix.M10 *= scalar; matrix.M11 *= scalar; matrix.M12 *= scalar;
      matrix.M20 *= scalar; matrix.M21 *= scalar; matrix.M22 *= scalar;
    ...
    /// <param name="matrix2">The second matrix.</param>
    /// <returns>The matrix with the product the two matrices.</returns>
    public static Matrix33D Multiply(Matrix33D matrix1, Matrix33D matrix2)
    {
      Matrix33D product;
      product.M00 = matrix1.M00 * matrix2.M00 + matrix1.M01 * matrix2.M10 + matrix1.M02 * matrix2.M20;
      product.M01 = matrix1.M00 * matrix2.M01 + matrix1.M01 * matrix2.M11 + matrix1.M02 * matrix2.M21;
    ...
    public static Vector3D operator *(Matrix33D matrix, Vector3D vector)
    {
      Vector3D result;
    ...
    /// <param name="vector">The column vector.</param>
    /// <returns>The resulting column vector.</returns>
    public static Vector3D Multiply(Matrix33D matrix, Vector3D vector)
    {
      Vector3D result;
      result.X = matrix.M00 * vector.X + matrix.M01 * vector.Y + matrix.M02 * vector.Z;
      result.Y = matrix.M10 * vector.X + matrix.M11 * vector.Y + matrix.M12 * vector.Z;
    ...
    /// vector.
    /// </remarks>
    public static Vector3D MultiplyTransposed(Matrix33D matrix, Vector3D vector)
    {
      Vector3D result;
    ...
    /// <param name="scalar">The scalar.</param>
    /// <returns>The matrix with each element divided by scalar.</returns>
    public static Matrix33D Divide(Matrix33D matrix, double scalar)
    {
      double f = 1 / scalar;
      matrix.M00 *= f; matrix.M01 *= f; matrix.M02 *= f;
      matrix.M10 *= f; matrix.M11 *= f; matrix.M12 *= f;
    ...
    /// </remarks>
    public static bool operator ==(Matrix33D matrix1, Matrix33D matrix2)
    {
    ...
    /// 
    /// <summary>
    /// Performs an explicit conversion from <see cref="Matrix33D"/> to a 2-dimensional 
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="Matrix33D"/> to a jagged 
    /// <see langword="double"/> array.
    /// </summary>
    /// <param name="matrix">The matrix.</param>
    /// <returns>The result of the conversion.</returns>
    public static explicit operator double[][](Matrix33D matrix)
    {
      ...
      result[0] = new double[3]; result[1] = new double[3]; result[2] = new double[3];
    ...
    /// <summary>
    /// Converts this <see cref="Matrix33D"/> to a jagged <see langword="double"/> array.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an implicit conversion from <see cref="Matrix33D"/> to <see cref="MatrixD"/>.
    /// </summary>
    /// <param name="matrix">The matrix.</param>
    /// <returns>The result of the conversion.</returns>
    public static implicit operator MatrixD(Matrix33D matrix)
    {
      MatrixD result = new MatrixD(3, 3);
      result[0, 0] = matrix.M00; result[0, 1] = matrix.M01; result[0, 2] = matrix.M02;
      result[1, 0] = matrix.M10; result[1, 1] = matrix.M11; result[1, 2] = matrix.M12;
      result[2, 0] = matrix.M20; result[2, 1] = matrix.M21; result[2, 2] = matrix.M22;
      return result;
    ...
    /// <summary>
    /// Converts this <see cref="Matrix33D"/> to <see cref="MatrixD"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Gets a column as <see cref="Vector3D"/>.
    /// </summary>
    ...
    /// <summary>
    /// Sets a column from a <see cref="Vector3D"/>.
    /// </summary>
    /// <param name="index">The index of the column (0, 1, or 2).</param>
    ...
    /// The <paramref name="index"/> is out of range.
    /// </exception>
    public void SetColumn(int index, Vector3D columnVector)
    {
      switch (index)
      {
        case 0:
    ...
    /// <summary>
    /// Gets a row as <see cref="Vector3D"/>.
    /// </summary>
    ...
    /// <summary>
    /// Sets a row from a <see cref="Vector3D"/>.
    /// </summary>
    /// <param name="index">The index of the row (0, 1, or 2).</param>
    ...
    /// The <paramref name="index"/> is out of range.
    /// </exception>
    public void SetRow(int index, Vector3D rowVector)
    {
      switch (index)
      {
        case 0:
    ...
    public void Orthogonalize()
    {
      ...
      var column0 = new Vector3D(M00, M10, M20);
      var column1 = new Vector3D(M01, M11, M21);
      var column2 = new Vector3D(M02, M12, M22);

      column1 = column1 - Vector3D.ProjectTo(column1, column0);
      column2 = column2 - Vector3D.ProjectTo(column2, column0) - Vector3D.ProjectTo(column2, column1);
    ...
    {
      List<double> result = new List<double>(9);
    ...
    public bool TryInvert()
    {
      ...
      double m11m22_m12m21 = M11 * M22 - M12 * M21;
      double m10m22_m12m20 = M10 * M22 - M12 * M20;
      double m10m21_m20m11 = M10 * M21 - M20 * M11;
      double determinant = M00 * m11m22_m12m21 - M01 * m10m22_m12m20 + M02 * m10m21_m20m11;
      ...
      if (Numeric.IsZero(determinant, Numeric.EpsilonDSquared * Numeric.EpsilonD))
        return false;

      Matrix33D transposedAdjoint;
    ...
    public static Matrix33D Absolute(Matrix33D matrix)
    {
      return new Matrix33D(Math.Abs(matrix.M00), Math.Abs(matrix.M01), Math.Abs(matrix.M02),
    ...
    /// </remarks>
    public static bool AreNumericallyEqual(Matrix33D matrix1, Matrix33D matrix2)
    {
    ...
    /// </remarks>
    public static bool AreNumericallyEqual(Matrix33D matrix1, Matrix33D matrix2, double epsilon)
    {
    ...
    /// otherwise it remains unchanged.
    /// </remarks>
    public static Matrix33D ClampToZero(Matrix33D matrix)
    {
    ...
    /// remains unchanged.
    /// </remarks>
    public static Matrix33D ClampToZero(Matrix33D matrix, double epsilon)
    {
    ...
    public static Matrix33D CreateScale(double scale)
    {
      Matrix33D result = new Matrix33D
      {
        M00 = scale,
        M11 = scale,
        M22 = scale
    ...
    /// <returns>The created scaling matrix.</returns>
    public static Matrix33D CreateScale(double scaleX, double scaleY, double scaleZ)
    {
      Matrix33D result = new Matrix33D
      {
        M00 = scaleX,
    ...
    /// <returns>The created scaling matrix.</returns>
    public static Matrix33D CreateScale(Vector3D scale)
    {
      Matrix33D result = new Matrix33D
      {
        M00 = scale.X,
    ...
    /// </exception>
    public static Matrix33D CreateRotation(Vector3D axis, double angle)
    {
    ...
    /// <param name="angle">The rotation angle in radians.</param>
    /// <returns>The created rotation matrix.</returns>
    public static Matrix33D CreateRotationX(double angle)
    {
      double cos = Math.Cos(angle);
      double sin = Math.Sin(angle);
      return new Matrix33D(1, 0, 0,
                           0, cos, -sin,
                           0, sin, cos);
    }
    ...
    /// <param name="angle">The rotation angle in radians.</param>
    /// <returns>The created rotation matrix.</returns>
    public static Matrix33D CreateRotationY(double angle)
    {
      double cos = Math.Cos(angle);
      double sin = Math.Sin(angle);
      return new Matrix33D(cos, 0, sin,
                           0, 1, 0,
                           -sin, 0, cos);
    }
    ...
    /// <param name="angle">The rotation angle in radians.</param>
    /// <returns>The created rotation matrix.</returns>
    public static Matrix33D CreateRotationZ(double angle)
    {
      double cos = Math.Cos(angle);
      double sin = Math.Sin(angle);
      return new Matrix33D(cos, -sin, 0,
                           sin, cos, 0,
                           0, 0, 1);
    }
    #endregion

...
namespace DigitalRune.Mathematics.Algebra
{
      ...
      IXmlSerializable
  {
    ...
    /// <overloads>
    /// <summary>
    /// Initializes a new instance of the <see cref="VectorD"/> class.
    /// </summary>
    /// </overloads>
    /// 
    /// <summary>
    ...
    /// </remarks>
    public VectorD(int numberOfElements, double value)
    ...
    /// <remarks>
    /// The created <see cref="VectorD"/> will have the same number of elements as the array 
    ...
    /// <remarks>
    /// The created <see cref="VectorD"/> will have the same number of elements as the list 
    /// <paramref name="elements"/>.
    /// </remarks>
    /// <exception cref="NullReferenceException">
    /// <paramref name="elements"/> must not be <see langword="null"/>.
    ...
    protected VectorD(SerializationInfo info, StreamingContext context)
    {
      try
      {
        _v = (double[])info.GetValue("Elements", typeof(double[]));
      }
    ...
    public void ReadXml(XmlReader reader)
    {
      ...
      _v = new double[n];
      for (int i = 0; i < n; i++)
        _v[i] = reader.ReadElementContentAsDouble();
    ...
    /// <param name="vector">The vector.</param>
    /// <returns>The negated vector.</returns>
    public static VectorD Negate(VectorD vector)
    {
      return -vector;
    }
    ...
    public static VectorD operator +(VectorD vector1, VectorD vector2)
    {
      ...
      VectorD result = new VectorD(vector1.NumberOfElements);
      for (int i = 0; i < result.NumberOfElements; i++)
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static VectorD operator -(VectorD minuend, VectorD subtrahend)
    {
      if (minuend == null)
      ...
      VectorD result = new VectorD(minuend.NumberOfElements);
      for (int i = 0; i < result.NumberOfElements; i++)
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static VectorD Subtract(VectorD minuend, VectorD subtrahend)
    {
    ...
    /// <param name="vector2">The second vector.</param>
    /// <returns>The element-wise product of the two vectors.</returns>
    public static VectorD Multiply(VectorD vector1, VectorD vector2)
    {
      return vector1 * vector2;
    }
    ...
    public static VectorD operator /(VectorD dividend, VectorD divisor)
    {
      ...
      VectorD result = new VectorD(dividend.NumberOfElements);
      for (int i = 0; i < result.NumberOfElements; i++)
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static VectorD Divide(VectorD dividend, VectorD divisor)
    {
    ...
    public static explicit operator double[](VectorD vector)
    {
      if (vector == null)
        return null;

      double[] result = new double[vector.NumberOfElements];
    ...
    public static explicit operator List<double>(VectorD vector)
    {
      ...
      List<double> result = new List<double>(vector.NumberOfElements);
      for (int i = 0; i < vector.NumberOfElements; i++)
        result.Add(vector[i]);
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="VectorD"/> to <see cref="Vector2D"/>.
    /// </summary>
    /// <param name="vector">The vector.</param>
    ...
    /// </exception>
    public static explicit operator Vector2D(VectorD vector)
    {
      if (vector == null)
        throw new ArgumentNullException("vector");
    ...
    /// <summary>
    /// Converts this <see cref="VectorD"/> to <see cref="Vector2D"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    /// <exception cref="InvalidCastException">
    /// This vector has more than 2 elements.
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="VectorD"/> to <see cref="Vector3D"/>.
    /// </summary>
    /// <param name="vector">The vector.</param>
    /// <returns>The result of the conversion.</returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// </exception>
    public static explicit operator Vector3D(VectorD vector)
    {
      if (vector == null)
        throw new ArgumentNullException("vector");
    ...
    /// <summary>
    /// Converts this <see cref="VectorD"/> to <see cref="Vector3D"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    /// <exception cref="InvalidCastException">
    /// This vector has more than 3 elements.
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="VectorD"/> to <see cref="Vector4D"/>.
    /// </summary>
    /// <param name="vector">The vector.</param>
    /// <returns>The result of the conversion.</returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// </exception>
    public static explicit operator Vector4D(VectorD vector)
    {
      if (vector == null)
        throw new ArgumentNullException("vector");
      ...
      return new Vector4D(vector[0], vector[1], vector[2], vector[3]);
    }


    /// <summary>
    /// Converts this <see cref="VectorD"/> to <see cref="Vector4D"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    /// <exception cref="InvalidCastException">
    /// This vector has more than 4 elements.
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="VectorD"/> to <see cref="VectorF"/>.
    /// </summary>
    /// <param name="vector">The vector.</param>
    /// <returns>The result of the conversion.</returns>
    public static explicit operator VectorF(VectorD vector)
    {
      if (vector == null)
        return null;
    ...
    /// <summary>
    /// Converts this <see cref="VectorD"/> to <see cref="VectorF"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="VectorD"/> to <see cref="MatrixD"/>.
    /// </summary>
    /// <param name="vector">The vector.</param>
    /// <returns>The result of the conversion.</returns>
    /// <remarks>
    ...
    /// </remarks>
    public static explicit operator MatrixD(VectorD vector)
    {
      if (vector == null)
        return null;

      MatrixD result = new MatrixD(vector.NumberOfElements, 1);
      for (int i = 0; i < vector.NumberOfElements; i++)
        result[i, 0] = vector[i];
    ...
    /// <summary>
    /// Converts this <see cref="VectorD"/> to <see cref="MatrixD"/>.
    /// </summary>
    /// <returns>The result of the conversion.</returns>
    /// <remarks>
    /// The created matrix will represent the vector as a column vector: <i>n</i> rows, 1 column.
    ...
    public VectorD GetSubvector(int startIndex, int subvectorLength)
    {
      ...
      VectorD result = new VectorD(subvectorLength);
    ...
    /// </exception>
    public void ProjectTo(VectorD target)
    {
      if (target == null)
    ...
    /// <paramref name="elements"/> must not be <see langword="null"/>.
    /// </exception>
    public void Set(IList<double> elements)
    {
      if (elements == null)
        throw new ArgumentNullException("elements");
    ...
    public static VectorD Absolute(VectorD vector)
    {
      if (vector == null)
        return null;
    ...
    /// <paramref name="vector1"/> or <paramref name="vector2"/> is <see langword="null"/>.
    /// </exception>
    public static bool AreNumericallyEqual(VectorD vector1, VectorD vector2)
    {
    ...
    /// <paramref name="vector1"/> or <paramref name="vector2"/> is <see langword="null"/>.
    /// </exception>
    public static bool AreNumericallyEqual(VectorD vector1, VectorD vector2, double epsilon)
    {
      if (vector1 == null && vector2 == null)
        return true;
    ...
    /// set to <paramref name="max"/>.
    /// </remarks>
    public static VectorD Clamp(VectorD vector, double min, double max)
    {
      if (vector == null)
        return null;
    ...
    /// otherwise it remains unchanged.
    /// </remarks>
    public static VectorD ClampToZero(VectorD vector)
    {
      if (vector == null)
        return null;
    ...
    /// remains unchanged.
    /// </remarks>
    public static VectorD ClampToZero(VectorD vector, double epsilon)
    {
      if (vector == null)
        return null;
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static double Dot(VectorD vector1, VectorD vector2)
    {
      if (vector1 == null)
        throw new ArgumentNullException("vector1");
      if (vector2 == null)
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static VectorD Min(VectorD vector1, VectorD vector2)
    {
      if (vector1 == null)
        throw new ArgumentNullException("vector1");
      if (vector2 == null)
      ...
      VectorD min = new VectorD(vector1.NumberOfElements);
    ...
    /// The numbers of elements of the two vectors do not match.
    /// </exception>
    public static VectorD Max(VectorD vector1, VectorD vector2)
    {
      if (vector1 == null)
        throw new ArgumentNullException("vector1");
      if (vector2 == null)
      ...
      VectorD max = new VectorD(vector1.NumberOfElements);
    ...
    /// </exception>
    public static VectorD ProjectTo(VectorD vector, VectorD target)
    {
      if (vector == null)
        throw new ArgumentNullException("vector");
      if (target == null)

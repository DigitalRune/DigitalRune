...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  /// <remarks>
  /// <para>
  /// A <see cref="CatmullRomSegment3F"/> can be used to smoothly interpolate between two points.
  /// </para>
  /// <para>
  ...
  public class CatmullRomSegment3F : ICurve<float, Vector3F>, IRecyclable
  {
    ...
    private static readonly ResourcePool<CatmullRomSegment3F> Pool = new ResourcePool<CatmullRomSegment3F>(
       () => new CatmullRomSegment3F(),               // Create
       null,                                          // Initialize
       null                                           // Uninitialize
       );
    ...
    /// <summary>
    /// Creates an instance of the <see cref="CatmullRomSegment3F"/> class. (This method reuses a 
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="CatmullRomSegment3F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static CatmullRomSegment3F Create()
    {
      return Pool.Obtain();
    }

...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  /// <remarks>
  /// <para>
  /// A <see cref="CardinalSegment2F"/> can be used to smoothly interpolate between two points.
  /// </para>
  /// <para>
  ...
  /// </para>
  /// </remarks>
  public class CardinalSegment2F : ICurve<float, Vector2F>, IRecyclable
  {
    /// <summary>
    ...
    private static readonly ResourcePool<CardinalSegment2F> Pool = new ResourcePool<CardinalSegment2F>(
       () => new CardinalSegment2F(),                 // Create
       null,                                          // Initialize
       null                                           // Uninitialize
       );
    ...
    /// <summary>
    /// Creates an instance of the <see cref="CardinalSegment2F"/> class. (This method reuses a
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="CardinalSegment2F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static CardinalSegment2F Create()
    {
      return Pool.Obtain();
    }

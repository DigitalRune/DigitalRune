...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  /// <remarks>
  /// <para>
  /// A <see cref="BezierSegment3F"/> can be used to smoothly interpolate between two points.
  /// </para>
  /// <para>
  ...
  public class BezierSegment3F : ICurve<float, Vector3F>, IRecyclable
  {
    ...
    private static readonly ResourcePool<BezierSegment3F> Pool = new ResourcePool<BezierSegment3F>(
       () => new BezierSegment3F(),                   // Create
       null,                                          // Initialize
       null                                           // Uninitialize
       );
    ...
    /// <summary>
    /// Creates an instance of the <see cref="BezierSegment3F"/> class. (This method reuses a
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="BezierSegment3F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static BezierSegment3F Create()
    {
      return Pool.Obtain();
    }

...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  /// <remarks>
  /// <para>
  /// A <see cref="HermiteSegment3F"/> can be used to smoothly interpolate between two points.
  /// </para>
  /// <para>
  ...
  public class HermiteSegment3F : ICurve<float, Vector3F>, IRecyclable
  {
    ...
    private static readonly ResourcePool<HermiteSegment3F> Pool = new ResourcePool<HermiteSegment3F>(
       () => new HermiteSegment3F(),                  // Create
       null,                                          // Initialize
       null                                           // Uninitialize
       );
    ...
    /// <summary>
    /// Creates an instance of the <see cref="HermiteSegment3F"/> class. (This method reuses a
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="HermiteSegment3F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static HermiteSegment3F Create()
    {
      return Pool.Obtain();
    }

...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  /// <remarks>
  /// <para>
  /// A <see cref="BSplineSegment3F"/> can be used to smoothly interpolate between two points.
  /// </para>
  /// <para>
  ...
  /// </para>
  /// </remarks>
  public class BSplineSegment3F : ICurve<float, Vector3F>, IRecyclable
  {
    /// <summary>
    ...
    /// <summary>
    /// Creates an instance of the <see cref="BSplineSegment3F"/> class. (This method reuses a
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="BSplineSegment3F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static BSplineSegment3F Create()
    {
      return Pool.Obtain();
    }

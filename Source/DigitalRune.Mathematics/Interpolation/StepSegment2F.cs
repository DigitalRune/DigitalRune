...
namespace DigitalRune.Mathematics.Interpolation
{
  ...
  public class StepSegment2F : ICurve<float, Vector2F>, IRecyclable
  {
    ...
    private static readonly ResourcePool<StepSegment2F> Pool = new ResourcePool<StepSegment2F>(
       () => new StepSegment2F(),                     // Create
       null,                                          // Initialize
       null                                           // Uninitialize
       );
    ...
    /// <summary>
    /// Creates an instance of the <see cref="StepSegment2F"/> class. (This method reuses a
    /// previously recycled instance or allocates a new instance if necessary.)
    /// </summary>
    /// <returns>
    /// A new or reusable instance of the <see cref="StepSegment2F"/> class.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public static StepSegment2F Create()
    {
      return Pool.Obtain();
    }

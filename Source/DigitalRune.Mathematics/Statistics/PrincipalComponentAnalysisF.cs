...
namespace DigitalRune.Mathematics.Statistics
{
  ...
  /// <see cref="EigenvalueDecompositionF"/> on the covariance matrix. The resulting eigenvectors
  ...
  public class PrincipalComponentAnalysisF
  {
    ...
    public MatrixF V { get; private set; }
    ...
    /// first element.
    /// </remarks>
    public VectorF Variances { get; private set; }
    #endregion

...
{
  /// <summary>
  /// Reads a <see cref="PathKey2F"/> from binary format. (Only available in the XNA-compatible
  /// build.)
  /// </summary>
  /// <remarks>
  ...
  public class PathKey2FReader : ContentTypeReader<PathKey2F>
  {
    ...
    protected override PathKey2F Read(ContentReader input, PathKey2F existingInstance)
    {
      if (existingInstance == null)
        existingInstance = new PathKey2F();

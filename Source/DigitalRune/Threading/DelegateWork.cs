#region ----- Copyright -----
/*
  The class in this file is based on the DelegateWork from the ParallelTasks library (see 
...
namespace DigitalRune.Threading
{
  ...
  {
    private static readonly ResourcePool<DelegateWork> Pool = new ResourcePool<DelegateWork>(
      () => new DelegateWork(),   // Create
      null,                       // Initialize
      null);                      // Uninitialize
    ...
    private DelegateWork()
    {
    }


    public static DelegateWork Create()
    {
      return Pool.Obtain();
    }

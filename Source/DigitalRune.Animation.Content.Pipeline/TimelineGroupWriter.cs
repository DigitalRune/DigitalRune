...
{
  /// <summary>
  /// Writes a <see cref="TimelineGroup"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class TimelineGroupWriter : ContentTypeWriter<TimelineGroup>
  {
    /// <summary>
    ...
    {
      return typeof(TimelineGroup).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(TimelineGroupReader).AssemblyQualifiedName;
    }

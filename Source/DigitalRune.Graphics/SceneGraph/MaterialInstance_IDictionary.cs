...
namespace DigitalRune.Graphics.SceneGraph
{
  partial class MaterialInstance
  {
    ...
    /// <summary>
    /// Adds an item to the <see cref="ICollection{T}"/>. This implementation always throws 
    ...
    /// <see cref="IDictionary{TKey,TValue}"/>.This implementation always throws 
    /// <see cref="NotSupportedException"/>.
    /// </summary>
    ...
    /// <summary>
    /// Removes all items from the <see cref="ICollection{T}"/>. This implementation always throws 
    /// <see cref="NotSupportedException"/>.
    /// </summary>
    /// <exception cref="NotSupportedException">
    /// Always thrown.
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
    void ICollection<KeyValuePair<string, EffectBinding>>.Clear()
    {
      throw new NotSupportedException("The MaterialInstance is a read-only collection.");
    }
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
    bool IDictionary<string, EffectBinding>.Remove(string key)
    {
      throw new NotSupportedException("The MaterialInstance is a read-only collection.");
    }

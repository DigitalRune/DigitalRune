...
namespace DigitalRune.Graphics.Effects
{
  ...
  /// </remarks>
  public class EffectInterpreterCollection : Collection<IEffectInterpreter>
  {
    /// <summary>
    /// Returns an enumerator that iterates through the 
    /// <see cref="EffectInterpreterCollection"/>. 
    /// </summary>
    /// <returns>
    /// An <see cref="IEnumerable{T}"/> for <see cref="EffectInterpreterCollection"/>.
    /// </returns>
    public new List<IEffectInterpreter>.Enumerator GetEnumerator()
    {
      return ((List<IEffectInterpreter>)Items).GetEnumerator();
    }
    ...
    /// </exception>
    protected override void InsertItem(int index, IEffectInterpreter item)
    {
      if (item == null)
    ...
    /// <paramref name="item"/> is already contained in the collection. 
    /// </exception>
    protected override void SetItem(int index, IEffectInterpreter item)
    {
      if (item == null)
        throw new ArgumentNullException("item", "null items are not allowed in this collection.");

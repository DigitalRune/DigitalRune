...
{
  /// <summary>
  /// Writes a <see cref="AabbTree{T}"/> to binary format.
  /// </summary>
  /// <typeparam name="T">The type of the item in the spatial partition.</typeparam>
  [ContentTypeWriter]
  [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
  public class AabbTreeWriter<T> : ContentTypeWriter<AabbTree<T>>
  {
    /// <summary>
    ...
    {
      return typeof(AabbTree<T>).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(AabbTreeReader<T>).AssemblyQualifiedName;
    }

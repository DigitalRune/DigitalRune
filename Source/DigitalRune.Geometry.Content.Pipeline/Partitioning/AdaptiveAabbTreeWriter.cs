...
{
  /// <summary>
  /// Writes a <see cref="AdaptiveAabbTree{T}"/> to binary format.
  /// </summary>
  /// <typeparam name="T">The type of the items in the spatial partition.</typeparam>
  [ContentTypeWriter]
  [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
  public class AdaptiveAabbTreeWriter<T> : ContentTypeWriter<AdaptiveAabbTree<T>>
  {
    /// <summary>
    ...
    {
      return typeof(AdaptiveAabbTree<T>).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(AdaptiveAabbTreeReader<T>).AssemblyQualifiedName;
    }

...
{
  /// <summary>
  /// Writes a <see cref="GeometricObject"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class GeometricObjectWriter : ContentTypeWriter<GeometricObject>
  {
    /// <summary>
    ...
    {
      return typeof(GeometricObject).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(GeometricObjectReader).AssemblyQualifiedName;
    }

...
{
  /// <summary>
  /// Writes a <see cref="ConeShape"/> to binary format.
  /// </summary>
  [ContentTypeWriter]
  public class ConeShapeWriter : ContentTypeWriter<ConeShape>
  {
    /// <summary>
    ...
    {
      return typeof(ConeShape).AssemblyQualifiedName;
    }
    ...
    {
      return typeof(ConeShapeReader).AssemblyQualifiedName;
    }
